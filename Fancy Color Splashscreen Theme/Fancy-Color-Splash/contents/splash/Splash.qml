...
Image {
    ...
    Item {
        ...
        Image {
            ...
            y: root.height - (root.height - logo.y) / 1.1 - height/0.45
            anchors.horizontalCenter: parent.horizontalCenter
    ...
    Text {
        ...
        y: (root.height / 3) * 2
        anchors.centerIn: parent
        text: "Symple by default, Powerful when needed!"
        visible: false
    }
    LinearGradient  {
        anchors.fill: text
        source: text
        gradient: Gradient {
             GradientStop { position: 0; color: "#088297" }
             GradientStop { position: 0.4; color: "#088297" }
             GradientStop { position: 0.6; color: "#0099e6" }
             GradientStop { position: 1; color: "#0099e6" }
        }
    }
}
